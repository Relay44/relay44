...
export const metadata = buildPageMetadata({
  ...
  description: 'Terms of service governing access to and use of the relay44 platform.',
  path: '/legal/terms',
    ...
    <>
      <StructuredData
        data={[
          buildWebPageStructuredData({
            path: '/legal/terms',
            name: 'relay44 terms of service',
            description:
              'Terms of service governing access to and use of the relay44 platform.',
          }),
          buildBreadcrumbStructuredData([
            { name: 'Home', url: '/' },
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-text-secondary">
          ...
          <section>
            ...
            <p>
              By accessing or using relay44 (&quot;the Platform&quot;), you agree to be bound by
          ...
          <section>
            ...
            <p>
              relay44 provides a decentralized prediction market platform built on the
