...
export const metadata = buildPageMetadata({
  ...
  description: 'Privacy policy covering how relay44 collects, uses, and protects user data.',
  path: '/legal/privacy',
  keywords: ['privacy policy', 'data policy'],
});
    ...
    <>
      <StructuredData
        data={[
          buildWebPageStructuredData({
            path: '/legal/privacy',
            name: 'relay44 privacy policy',
            description:
              'Privacy policy covering how relay44 collects, uses, and protects user data.',
          }),
          buildBreadcrumbStructuredData([
            { name: 'Home', url: '/' },
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-text-secondary">
          ...
          <section>
            ...
            <p>
              relay44 (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) respects your privacy and is committed to
