...
export const apiBase = normalizeApiBase(process.env.API_URL);
export const apiOrigin = apiBase.replace(/\/v1$/, '');
export const siweDomain = (process.env.SIWE_DOMAIN || 'localhost:3000').trim();
export const chainId = Number(process.env.BASE_CHAIN_ID || 8453);
...
export async function loginAdmin() {
  const privateKey = envOrThrow('ADMIN_PRIVATE_KEY');
